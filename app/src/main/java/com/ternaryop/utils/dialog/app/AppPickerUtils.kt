...
object AppPickerUtils {
    ...
    fun getDefaultViewerComponentName(context: Context, fullPath: String, mimeType: String): ComponentName? {
        val viewer = PreferenceManager.getDefaultSharedPreferences(context).getString(DEFAULT_VIEWER_PREFIX + fullPath, null)
        ?: PreferenceManager.getDefaultSharedPreferences(context).getString(DEFAULT_VIEWER_PREFIX + mimeType, null)
        ?: return null
